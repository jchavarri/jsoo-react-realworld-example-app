                  ...
                  ~children:
                    [
                      fieldset ~className:"form-group"
                        ~children:
                          [
                            input ~type_:"text" ~className:"form-control form-control-lg" ~placeholder:"Article Title"
                              ~disabled:isBusy
                              ~value:
                                (data
                                |> Async_result.getOk
                      ...
                      fieldset ~className:"form-group"
                        ~children:
                          [
                            input ~type_:"text" ~className:"form-control" ~placeholder:"What's this article about?"
                              ~disabled:isBusy
                              ~value:
                                (data
                                |> Async_result.getOk
                      ...
                      fieldset ~className:"form-group"
                        ~children:
                          [
                            input ~type_:"text" ~className:"form-control" ~placeholder:"Enter tags" ~disabled:isBusy
                              ~value:
                                (data
                                |> Async_result.getOk
                                |> Option.map
                              ...
                              ~children:[] ();
                            div ~className:"tag-list" ~children:[] ();
                          ]
                        ();
                      button ~className:"btn btn-lg pull-xs-right btn-primary" ~type_:"button" ~disabled:isBusy
                        ~onClick:(fun event ->
