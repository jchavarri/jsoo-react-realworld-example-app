...
let%component make () =
  React.Fragment.make
    ~children:
      [ a
          ~href:
            ("https://github.com/jihchi/jsoo-react-realworld-example-app"
            [@reason.raw_literal
              "https://github.com/jihchi/jsoo-react-realworld-example-app"] )
          ~target:"_blank"
          ~style:
            (React.Dom.Style.make ~position:"fixed" ~bottom:"0" ~width:"100%"
               ...
               ~boxShadow:"0 5px 5px 5px rgba(0,0,0,0.4)" ~zIndex:"999"
               ~fontSize:"1.5rem" ~display:"block" ~color:"#fff" () )
          ~children:
            [ i ~className:"ion-social-github"
                ~style:(React.Dom.Style.make ~marginRight:"8px" ())
                ~children:[] ()
            ...
            [ div ~className:"container"
                ~children:
                  [ Link.make ~onClick:(Link.location Link.home)
                      ~className:"logo-font" ~children:[React.string "conduit"]
                      ()
                  ; span ~className:"attribution"
                      ~children:
                        [ React.string "An interactive learning project from "
                        ; a ~href:"https://thinkster.io"
                            ~children:[React.string "Thinkster"] ()
