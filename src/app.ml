let authenticated :
 ...
 fun getPage user ->
  ...
  | Some s ->
      getPage s
  | None ->
      Link.home |> Link.push ; React.null
        ...
        ~children:
          ...
          ; ( match route with
            | Settings ->
                ...
                (* authenticated
                   (fun user ->
                     Settings.createElement ~user ~setUser:setCurrentUser
                       ~children:[] () )
                   user *)
            | Login ->
                React.string "Login"
                (* Login.createElement ~setUser:setCurrentUser ~children:[] () *)
            | Register ->
                React.string "Register"
                (* Register.createElement ~setUser:setCurrentUser ~children:[] () *)
            | CreateArticle ->
            ...
            | EditArticle _slug ->
                ...
                (* authenticated
                   ...
                   user *)
            | Article _slug ->
                React.string "Article"
                (* Article.createElement ~slug ~user ~children:[] () *)
            | Profile _username ->
